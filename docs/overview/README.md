...
- [doc_governance.md](doc_governance.md)：文档命名、颗粒度与分类规则
- [doc_lifecycle_rules_20260311.md](doc_lifecycle_rules_20260311.md)：文档生命周期、归档流程与权限规则
- [merge_audit_checklist_20260311.md](merge_audit_checklist_20260311.md)：跨分支合入审核标准

### 项目规划

- [topic_maps.md](topic_maps.md)：交易 / 数据 / 训练三条主线的分层索引
- [topic_gaps.md](topic_gaps.md)：交易 / 数据 / 训练三条主线的高层缺口
...
- 这一层不定义具体字段和协议。
- 需要接口细节时，转到 [../interfaces/README.md](../interfaces/README.md)。
- 需要模块拆解时，转到 [../modules/README.md](../modules/README.md)。
