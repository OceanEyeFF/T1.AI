...
| 3 | WT-T1-A3 | 目录分层搬迁 + fixtures/factories（行为等价） | refactor | planned |
| 4 | WT-T1-A4 | markers + CI 分层 + cov 门禁落地 + 文档 + R4 延后交接 | test | planned |
...
- completed: 2
- completion_pct: 50
- note: A1+A2 done; Arch-v1 ready for A3; Cov-detail deferred to A4
- blocked: 0
- deferred: 0
